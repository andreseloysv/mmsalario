...
public class busca_empresa extends GenericTransaction {
	...
	public int service(Recordset inputParams) throws Throwable {
		...
		String resultado = "";
		System.out.print(inputParams.toString());
		
		String query="Select * from ";
		
		
		 resultado = ("holaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa");
//		Recordset aux_recordset = (Recordset) getRequest().getSession()
//				.getAttribute("detail.sql");
...
//								"cargo_fk", "valor" };
//						getDb().execBatch(getResource("insert.sql"),
//								rs_promedio, campos);
//					}
//				}
//			}
